...
import arrow.effects.typeclasses.suspended.concurrent.Fx as ConcurrentFx
...
//    suspend fun <S> saveWholePeriodAsync(employeeId: Long, records: RecordCollectionCreateDtoImpl, FX: Fx<S>): Kind<S, RecordCollectionCreateDtoImpl?>
//    suspend fun <S> updateWholePeriodAsync(employeeId: Long, records: RecordCollectionUpdateDtoImpl, FX: Fx<S>): Kind<S, RecordCollectionUpdateDtoImpl?>
