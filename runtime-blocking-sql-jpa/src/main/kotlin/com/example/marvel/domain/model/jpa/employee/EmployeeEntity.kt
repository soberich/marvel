...
fun EmployeeCreateCommand.toEmployee(mapper: EmployeeMapper): EmployeeCreateView =
        mapper.toEntity(this)
fun EmployeeUpdateCommand.toEmployee(id: Long, mapper: EmployeeMapper): EmployeeUpdateView =
        mapper.toEntity(id, this)
