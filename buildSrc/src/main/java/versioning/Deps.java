 ...
 * <pre>{@code
 *     Deps.Platforms
 *     String JACKSON   = "com.fasterxml.jackson:jackson-bom" + ':' + Versions.JACKSON = "com.fasterxml.jackson:jackson-bom:2.9.9"
 * }</pre>
 */
public interface Deps {
    ...
    interface Libs {
        ...
        String JACKSON_KOTLIN              = "com.fasterxml.jackson.module:jackson-module-kotlin"               + ':' + Versions.JACKSON;
